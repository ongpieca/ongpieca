      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center group">
            ...
            <p className={`text-black font-semibold transform transition-all duration-1200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>{t.stats.projectsCompleted}</p>
          </div>
          <div className="text-center group">
            ...
            <p className={`text-black font-semibold transform transition-all duration-1200 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>{t.stats.schoolsHealthCenters}</p>
          </div>
          <div className="text-center group">
            ...
            <p className={`text-black font-semibold transform transition-all duration-1200 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>{t.stats.waterWells}</p>
          </div>
          <div className="text-center group">
            ...
            <p className={`text-black font-semibold transform transition-all duration-1200 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>{t.stats.cataractSurgeries}</p>
          </div>
        </div>
      </div>
    </section>
